...
public class Contacts_UserService {
    ...
    private  static  String createUser_url= Utils.DIANXIN_URL+"user/create?access_token=ACCESS_TOKEN";
    private  static  String getUser_url= Utils.DIANXIN_URL+"user/get?access_token=ACCESS_TOKEN&userid=USERID";
    private  static  String updateUser_url= Utils.DIANXIN_URL+"user/update?access_token=ACCESS_TOKEN";
    private  static  String deleteUser_url= Utils.DIANXIN_URL+"user/delete?access_token=ACCESS_TOKEN&userid=USERID";
    private  static  String batchdeleteUser_url= Utils.DIANXIN_URL+"user/batchdelete?access_token=ACCESS_TOKEN";
    private  static  String getDepartmentUser_url= Utils.DIANXIN_URL+"user/simplelist?access_token=ACCESS_TOKEN&department_id=DEPARTMENT_ID&fetch_child=FETCH_CHILD";
    private  static  String getDepartmentUserDetails_url= Utils.DIANXIN_URL+"user/list?access_token=ACCESS_TOKEN&department_id=DEPARTMENT_ID&fetch_child=FETCH_CHILD";
    ...
    public void createUser(String accessToken,User user) {
        ...
        String s = WeiXinUtil.httpRequestPost(createUser_url,jsonU1);
        ...
        if (null != jsonObject) {
            if (0 != jsonObject.getIntValue("errcode")) {
                log.error("创建成员失败 errcode:{} errmsg:{}", jsonObject.getIntValue("errcode"), jsonObject.getString("errmsg"));
            }
        }
    }
    ...
    public void getUser(String accessToken,String userId) {
        ...
        JSONObject jsonObject = WeiXinUtil.httpRequestGet(getUser_url, null);
        System.out.println("jsonObject:"+jsonObject.toString());
    ...
    public void updateUser(String accessToken,User user) {
        ...
        String s = WeiXinUtil.httpRequestPost(updateUser_url,jsonU1);
        com.alibaba.fastjson.JSONObject jsonObject = (com.alibaba.fastjson.JSONObject)com.alibaba.fastjson.JSON.parseObject(s);
        ...
        if (null != jsonObject) {
            if (0 != jsonObject.getIntValue("errcode")) {
                log.error("更新成员失败 errcode:{} errmsg:{}", jsonObject.getIntValue("errcode"), jsonObject.getString("errmsg"));
            }
        }
    }
    ...
    public void deleteUser(String accessToken,String userId) {
        ...
        JSONObject jsonObject = WeiXinUtil.httpRequestGet(deleteUser_url,null);
        System.out.println("jsonObject:"+jsonObject.toString());
    ...
    public void batchdeleteUser(String accessToken,List<String> userIdList){
        ...
        String s = WeiXinUtil.httpRequestPost(batchdeleteUser_url,useridlist);
        com.alibaba.fastjson.JSONObject jsonObject = (com.alibaba.fastjson.JSONObject)com.alibaba.fastjson.JSON.parseObject(s);
    ...
    public void getDepartmentUser(String accessToken,String departmentId,String fetchChild) {
        ...
        JSONObject jsonObject = WeiXinUtil.httpRequestGet(getDepartmentUser_url,null);
        System.out.println("jsonObject:"+jsonObject.toString());
    ...
    public void getDepartmentUserDetails(String accessToken,String departmentId,String fetchChild) {
        ...
        JSONObject jsonObject = WeiXinUtil.httpRequestGet(getDepartmentUserDetails_url,null);
        System.out.println("jsonObject:"+jsonObject.toString());
